(() => {
  ...
  const storageKey = "criptografia-modulo-04-progreso-v1";
  ...
  function updateProgress() {
    ...
    if (nextAnchor) {
      ...
      continueLink.href = "evaluacion-integradora-esteganografia.html";
      continueLink.textContent = "Revisar la evaluación";
    }
  }
  ...
  reset?.addEventListener("click", () => {
    if (!window.confirm("¿Reiniciar el progreso guardado para los 15 recursos?")) return;
    cards.forEach((card) => {
