...
<details> <summary><strong>Resumen:</strong> <em>(haz clic para expandir)</em></summary> <p> Esta herramienta descompone el protocolo Fiat-Shamir, uno de los fundamentos de la criptografía de conocimiento cero. Permite explorar el flujo completo de mensajes entre probador y verificador, visualizar cómo se construye una prueba segura y comprender la transición entre el modelo interactivo y el no interactivo mediante funciones hash. Incluye explicaciones visuales para cada fase del protocolo y destaca su relevancia en la autenticación segura, firmas digitales y privacidad en blockchain. </p> </details> | [![Explorar Fiat-Shamir](https://img.shields.io/badge/Explorar-Fiats_Shamir-blueviolet?style=for-the-badge&logo=html5)](https://github.com/sgevatschnaider/CriptografiayBlockchain/blob/08b5710abe6964e737fd24ee1e9f8d6bf4ac44d8/recursos/protocolo_fiat-shamir.html) |
